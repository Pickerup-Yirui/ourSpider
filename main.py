...
def crawling():
    ...
    #print("url468",jobUrls[467],jobUrls[468],jobUrls[469])---------------
    #----建立爬取失败的url的仓库
    CanNotCrawl = uP()
    #----建立爬取结果的储存字典
    if URL_BUILD_MODE == 1:
    ...
    while True:
        ...
        if titleAndSalary == -1:
            print("无法解析出职位名与薪资的网址是：",url1)
        elif titleAndSalary == -2:
            print("无法解析出公司名的网址是：",url1)
        elif titleAndSalary == -3:
            print("无法解析出岗位信息的网址是：", url1)
